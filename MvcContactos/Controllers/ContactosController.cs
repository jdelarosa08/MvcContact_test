...
namespace MvcContactos.Controllers
{
    public class ContactosController : Controller
    {
        private readonly MvcContactosContext _context;

        public ContactosController(MvcContactosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Email,Telefono")] Contactos contactos)
        {
